...
class add_technical:
    ...
    def lag_make(self, df, serries_column, lag_span):
        """
    ...
    def momentums(self, df, open, high, low, close, volume):
        ...
        for span in momentum_rsi_span:
            ...
            self.lag_make(df_c[f"momentum_rsi{span}"])
        ...
        for span in momentum_stoch_rsi_span:
            ...
            self.lag_make(df_c[f"momentum_stoch_rsi{span}"])
            df_c[f"momentum_stoch_rsi_k{span}"] = ta.momentum.StochRSIIndicator(
                close, window=span, smooth1=3, smooth2=3, fillna=False
            ).stochrsi_k()
            self.lag_make(df_c[f"momentum_stoch_rsi_k{span}"])
            df_c[f"momentum_stoch_rsi_d{span}"] = ta.momentum.StochRSIIndicator(
                close, window=span, smooth1=3, smooth2=3, fillna=False
            ).stochrsi_d()
            self.lag_make(df_c[f"momentum_stoch_rsi_d{span}"])
        ...
        for s, f in momentum_tsi_span:
            ...
            self.lag_make(df_c[f"momentum_tsi{s}"])
        ...
        for span in momentum_uo_span:
            ...
            self.lag_make(df_c[f"momentum_uo{span}"])
        ...
        for span in momentum_wr_span:
            ...
            self.lag_make(df_c[f"momentum_wr{span}"])
        ...
        for w1, w2 in trend_macd_span:
            ...
            self.lag_make(df_c[f"momentum_ao{w1}"])
        ...
        for span in momentum_roc_span:
            ...
            self.lag_make(df_c[f"momentum_roc{span}"])
        ...
        for span in momentum_kama_span:
            ...
            self.lag_make(df_c[f"momentum_kama{span}"])
            df_c[f"momentum_kama_st{span}"] = df_c[f"momentum_kama{span}"] / close
            self.lag_make(df_c[f"momentum_kama_st{span}"])
        ...
        for window1, window2 in momentum_sonar_span:
            ...
            self.lag_make(df_c[f"momentum_sonar{window1}"])
        ...
        for window in momentum_abratio_span:
            ...
            self.lag_make(df_c[f"momentum_aratio{window}"])
            ...
            self.lag_make(df_c[f"momentum_bratio{window}"])
        ...
        for window in momentum_rci_span:
            ...
            self.lag_make(df_c[f"momentum_rci{window}"])
        ...
        for window in momentum_sigma_span:
            ...
            self.lag_make(df_c[f"momentum_sigma{window}"])
        ...
        for window1, window2, window3 in momentum_aso_span:
            ...
            self.lag_make(df_c[f"momentum_aso{window1}"])
        ...
        for window in momentum_cmo_span:
            ...
            self.lag_make(df_c[f"momentum_cmo{window}"])
        ...
        for window in momentum_morrisrsi_span:
            ...
            self.lag_make(df_c[f"momentum_morrisrsi{window}"])
        ...
        for window in momentum_imi_span:
            ...
            self.lag_make(df_c[f"momentum_imi{window}"])
        ...
        for gamma in gamma_span:
            ...
            self.lag_make(df_c[f"momentum_lagrsi{gamma}"])
    ...
    def trends(self, df, open, high, low, close, volume):
        ...
        for s, f in trend_macd_span:
            ...
            self.lag_make(df_c[f"trend_macd{s}_{f}"])
            df_c[f"trend_macd_signal{s}_{f}"] = ta.trend.MACD(
                close, window_slow=s, window_fast=f, window_sign=9, fillna=False
            ).macd_signal()
            self.lag_make(df_c[f"trend_macd_signal{s}_{f}"])
            df_c[f"trend_macd_diff{s}_{f}"] = ta.trend.MACD(
                close, window_slow=s, window_fast=f, window_sign=9, fillna=False
            ).macd_diff()
            self.lag_make(df_c[f"trend_macd_diff{s}_{f}"])
        ...
        for span in trend_trix_span:
            ...
            self.lag_make(df_c[f"trend_trix{span}"])
        ...
        for f, s in trend_mass_index_span:
            ...
            self.lag_make(df_c[f"trend_mass_index{f}_{s}"])
        ...
        for span in trend_dpo_span:
            ...
            self.lag_make(df_c[f"trend_dpo{span}"])
        ...
        def kstindicator(
            ...
            df_c["trend_kst"] = kst
            self.lag_make(df_c["trend_kst"])
            df_c["trend_kst_sig"] = kst_sig
            self.lag_make(df_c["trend_kst_sig"])
            kst_diff = kst - kst_sig
            df_c["trend_kst_diff"] = kst_diff
            self.lag_make(df_c["trend_kst_diff"])
            return df_c
        ...
        for w1, w2, w3 in trend_ichimoku_span:
            ...
            self.lag_make(df_c[f"trend_ichimoku_conv{w1}"])
            df_c[f"trend_ichimoku_base{w1}"] = ta.trend.IchimokuIndicator(
                high, low, window1=w1, window2=w2, window3=w3, visual=False
            ).ichimoku_base_line()
            self.lag_make(df_c[f"trend_ichimoku_base{w1}"])
            df_c[f"trend_ichimoku_a{w1}"] = ta.trend.IchimokuIndicator(
                high, low, window1=w1, window2=w2, window3=w3, visual=False
            ).ichimoku_a()
            self.lag_make(df_c[f"trend_ichimoku_a{w1}"])
            df_c[f"trend_ichimoku_b{w1}"] = ta.trend.IchimokuIndicator(
                high, low, window1=w1, window2=w2, window3=w3, visual=False
            ).ichimoku_b()
            self.lag_make(df_c[f"trend_ichimoku_b{w1}"])
            ...
            self.lag_make(df_c[f"trend_ichimoku_sig_up{w1}"])
            df_c[f"trend_ichimoku_sig_down{w1}"] = np.where(
                (trend_ichimoku_sig1 == 0) & (trend_ichimoku_sig2 == 0), 1, 0
            )
            self.lag_make(df_c[f"trend_ichimoku_sig_down{w1}"])
        ...
        for s, f, c in trend_stc_span:
            ...
            self.lag_make(df_c[f"trend_stc{s}"])
        ...
        for span in trend_adx_span:
            ...
            self.lag_make(df_c[f"trend_adx{span}"])
            df_c[f"trend_adx_pos{span}"] = (
                ta.trend.ADXIndicator(high, low, close, window=span, fillna=False)
                .adx_pos()
                .replace(0, np.nan)
            )
            self.lag_make(df_c[f"trend_adx_pos{span}"])
            df_c[f"trend_adx_neg{span}"] = (
                ta.trend.ADXIndicator(high, low, close, window=span, fillna=False)
                .adx_neg()
                .replace(0, np.nan)
            )
            self.lag_make(df_c[f"trend_adx_neg{span}"])
        ...
        for span in trend_cci_span:
            ...
            self.lag_make(df_c[f"trend_cci{span}"])
        ...
        for window in trend_dmi_span:
            ...
            self.lag_make(df_c[f"trend_dmi_dip{window}"])
            self.lag_make(df_c[f"trend_dmi_din{window}"])
            self.lag_make(df_c[f"trend_dmi_sig{window}"])
        ...
        for window in trend_dem_span:
            ...
            self.lag_make(df_c[f"trend_dem{window}"])
    ...
    def volatilities(self, df, open, high, low, close, volume):
        ...
        self.lag_make(df_c["volatility_tr_st"])
        ...
        for ema_span in volatility_kcc_ema_span:
            for atr_span in volatility_kcc_atr_span:
                ...
                self.lag_make(df_c[f"volatility_kcc_ema{ema_span}atr{atr_span}"])
                df_c[
                    f"volatility_kch_ema{ema_span}atr{atr_span}"
                ] = kcc.keltner_channel_hband()
                self.lag_make(df_c[f"volatility_kch_ema{ema_span}atr{atr_span}"])
                df_c[
                    f"volatility_kcl_ema{ema_span}atr{atr_span}"
                ] = kcc.keltner_channel_lband()
                self.lag_make(df_c[f"volatility_kcl_ema{ema_span}atr{atr_span}"])
                df_c[
                    f"volatility_kcw_ema{ema_span}atr{atr_span}"
                ] = kcc.keltner_channel_wband()
                self.lag_make(df_c[f"volatility_kcw_ema{ema_span}atr{atr_span}"])
                df_c[
                    f"volatility_kcp_ema{ema_span}atr{atr_span}"
                ] = kcc.keltner_channel_pband()
                self.lag_make(df_c[f"volatility_kcp_ema{ema_span}atr{atr_span}"])
                df_c[
                    f"volatility_kchi_ema{ema_span}atr{atr_span}"
                ] = kcc.keltner_channel_hband_indicator()
                self.lag_make(df_c[f"volatility_kchi_ema{ema_span}atr{atr_span}"])
                df_c[
                    f"volatility_kcli_ema{ema_span}atr{atr_span}"
                ] = kcc.keltner_channel_lband_indicator()
                self.lag_make(df_c[f"volatility_kcli_ema{ema_span}atr{atr_span}"])
        # DonchianChannel
        ...
        for span in volatility_atr_span:
            ...
            self.lag_make(df_c[f"volatility_atr{span}"])

            # volatility_atr_st
            st = df_c[f"volatility_atr{span}"] / close
            df_c[f"volatility_atr_st{span}"] = st
            self.lag_make(df_c[f"volatility_atr_st{span}"])
        ...
        for span in volatility_ui_span:
            ...
            self.lag_make(df_c[f"volatility_ui{span}"])
        ...
        for window1, window2 in volatility_mi_span:
            ...
            self.lag_make(df_c[f"volatility_mi{window1}"])
        ...
        self.lag_make(df_c["volatility_hv"])
    ...
    def volumes(self, df, open, high, low, close, volume):
        ...
        for span in volume_cmf_span:
            ...
            self.lag_make(df_c[f"volume_cmf{span}"])
        ...
        for span in volume_fi_span:
            ...
            self.lag_make(df_c[f"volume_fi{span}"])
            df_c[f"volume_fi_diff{span}"] = df_c[f"volume_fi{span}"].diff()
            self.lag_make(df_c[f"volume_fi_diff{span}"])
        ...
        for span in volume_sma_em_span:
            ...
            self.lag_make(df_c[f"volume_sma_em{span}"])
        ...
        self.lag_make(df_c["volume_vpt"])
        df_c["volume_vpt_diff"] = df_c["volume_vpt"].diff()
        self.lag_make(df_c["volume_vpt_diff"])
        ...
        self.lag_make(df_c["volume_vwap"])
        ...
        for span in volume_mfi_span:
            ...
            self.lag_make(df_c[f"volume_mfi{span}"])
        ...
        for span in volume_vr_span:
            ...
            self.lag_make(df_c[f"volume_vr1_{span}"])
            self.lag_make(df_c[f"volume_vr2_{span}"])
        ...
        for window in volume_volumeratio_span:
            ...
            self.lag_make(df_c[f"volume_volumeratio{window}"])
        ...
        for window in volume_vzo_span:
            ...
            self.lag_make(df_c[f"volume_vzo{window}"])
    ...
    def others(self, df, open, high, low, close, volume):
        ...
        self.lag_make(df_c["others_pivot_price"])
        self.lag_make(df_c["others_pivot_hbop"])
        self.lag_make(df_c["others_pivot_r2"])
        self.lag_make(df_c["others_pivot_r1"])
        self.lag_make(df_c["others_pivot_s1"])
        self.lag_make(df_c["others_pivot_s2"])
        self.lag_make(df_c["others_pivot_lbop"])
        ...
        for span in fibo_span:
            ...
            for b in bairitsu:
                ...
                self.lag_make(df_c[f"others_fibo{span}_oshi{b}"])
                self.lag_make(df_c[f"others_fibo{span}_modoshi{b}"])
                self.lag_make(df_c[f"others_fibo{span}_oshi{b}_st"])
                self.lag_make(df_c[f"others_fibo{span}_modoshi{b}_st"])
        ...
        for span in psycholo_span:
            ...
            self.lag_make(df_c[f"others_psychological_{span}day"])
